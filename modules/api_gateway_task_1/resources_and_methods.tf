...
//Declare Path
resource "aws_api_gateway_resource" "pi_side_smart_home_task_1_register_endpoint"{
    rest_api_id = aws_api_gateway_rest_api.pi_side_smart_home_task_1_api_gateway.id
    parent_id = aws_api_gateway_rest_api.pi_side_smart_home_task_1_api_gateway.root_resource_id
    path_part   = "register"
}
